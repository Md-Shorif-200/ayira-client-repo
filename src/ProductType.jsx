...
const productOptions = [
  { id: "all", label: "ALL" },
  { id: "t-shirt-polo", label: "T-SHIRT & POLO" },
  { id: "hoodie-sweatshirt", label: "HOODIE & SWEATSHIRT" },
  { id: "sweater-shirts", label: "SWEATER, SHIRTS" },
  { id: "jeans", label: "JEANS" },
  { id: "jacket", label: "JACKET" },
  { id: "underwear", label: "UNDERWEAR" },
  { id: "shirts-blouse", label: "SHIRTS & BLOUSE" },
  { id: "sleepwear", label: "SLEEPWEAR" },
  { id: "children-set", label: "CHILDREN SET" },
