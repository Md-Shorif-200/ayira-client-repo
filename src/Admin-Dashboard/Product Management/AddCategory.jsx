...
const AddCategory = () => {
  ...
  <div className="max-w-4xl w-full p-8">
        ...
        <h1 className="text-[30px] font-bold text-gray-800 mb-6">Add New Category</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 p-6 border border-gray-200 rounded-lg">
          ...
          <div>
            ...
            <input
              id="catagory"
              type="text"
              {...register("catagory", { required: "Product catagory is required" })}
              className={inputStyle}
              placeholder="e.g. T-SHIRT & POLO,JEANS,JACKET"
            />
             {errors.catagory && <p className="text-red-500 text-xs mt-1">{errors.catagory.message}</p>}
          </div>
