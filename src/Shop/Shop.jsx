...
const shop_banner_img = "https://i.ibb.co.com/qYgq4M8m/download-14.jpg";
import { FaHome, FaListUl } from "react-icons/fa";
import ProductLines from "./ShopCategory/ProductLines";
import { BsFillGrid3X3GapFill } from "react-icons/bs";

import CommonBanner from "../Components/CommonBanner";
import ProductType from "./ShopCategory/ProductType";
          ...
          <div class="text-block-container max-w-4xl mx-auto py-8 text-gray-700">
            <div class="paragraph-section mb-8">
              <p>
                ...
                laoreet.{" "}
                <span class="highlight-text bg-black text-white px-2 py-1 font-bold">
